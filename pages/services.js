...
export default function AboutPage() {
  ...
  return (
    <>
      <Head>
        <title>Services | Wellness Wave Centre</title>
        <meta
          name="description"
        ...
        <div className="grid gap-12 lg:grid-cols-[3fr_2fr] lg:items-start">
          ...
          >
            ...
            <motion.p variants={fadeUp}>
              ...
              Personal training, group classes, yoga, Pilatesand HIIT programs.
            </motion.p>

            <motion.p variants={fadeUp}>
              <span className="font-semibold text-slate-900">
                4. Mindfulness and Meditation Sessions:
              </span>{" "}
            ...
            <motion.p variants={fadeUp}>
              <span className="font-semibold text-slate-900">
                8. Nutrition Education Workshops:
              </span>{" "}
            ...
            <motion.p variants={fadeUp}>
              <span className="font-semibold text-slate-900">
                10. Wellness Retreats and Getaways:
              </span>{" "}
            ...
            <motion.p variants={fadeUp}>
              <span className="font-semibold text-slate-900">
                12. Community Events and Support Groups:
              </span>{" "}
          ...
          >
            <img
              ...
              className="w-full h-full min-h-[500px] rounded-2xl border border-slate-200 object-cover shadow-soft"
            />
          </motion.div>
          ...
          {accordionData.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true, amount: 0.2 }}
                className="rounded-xl border border-slate-200 bg-blue-50 overflow-hidden scroll-mt-24"
              >
                <button
